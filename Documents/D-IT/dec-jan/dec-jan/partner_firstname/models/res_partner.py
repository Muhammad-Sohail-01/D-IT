...
class ResPartner(models.Model):
    ...
    # _rec_names_search = ['name', 'firstname', 'lastname','phone','mobile','address_area']
    ...
    @api.model
    def _name_search(self, name, args=None, operator="ilike", name_get_uid=None, limit=100, order=None):
        args = args or []
        domain = []
        if name:
