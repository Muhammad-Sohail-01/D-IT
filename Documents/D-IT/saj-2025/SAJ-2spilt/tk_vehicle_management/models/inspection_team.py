...
class InspectionTeam(models.Model):
    ...
    # technician_ids = fields.Many2many('res.users', 'team_technician_rel', 'technician_id',
    #                                   'technician_user_id',
    #                                   string='Technicians',
    #                                   domain="[('is_technician','=',True),
    #                                   ('employee_id','!=',False),]")

    default_team = fields.Boolean(String="Default Team", default=False)
    
    team_leader_ids = fields.Many2many('hr.employee', string="Team Leaders",
                                       domain=[('team_leader', '=', True)]
                                       )
    default_leader = fields.Boolean(String="Default Leader", default=False)
...
class HrEmployeeInherit(models.Model):
    ...
    default_team_leader = fields.Boolean(string="Default Team Leader")
    default_technician = fields.Boolean(string="Default Technician")
