...
class StockMove(models.Model):
    ...
    part_number_id = fields.Many2one('auto.mobile.product.product.partno.line', string="Part Number",
...
class PurchaseOrderLine(models.Model):
    ...
    part_number_id = fields.Many2one('auto.mobile.product.product.partno.line', string="Parts Number")  # Field to relate part numbers
