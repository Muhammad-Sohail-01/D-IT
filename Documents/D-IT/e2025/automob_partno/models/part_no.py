...
class PartNo(models.Model):
    ...
    product_variant_ids =fields.Many2one('product.product', string="variant Id", store=True,)
    product_variant_id =fields.Many2one('product.product', string="variant Ids", store=True,)
